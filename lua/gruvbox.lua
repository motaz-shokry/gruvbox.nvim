...
local function set_highlights()
  ...
  local legacy_highlights = {
    ...
    ["@boolean"] = { fg = palette.purple_lite, bold = true },
    ...
    ["@text"] = { fg = palette.fg1 },
    ["@text.danger"] = { fg = palette.red_lite, bold = true }, -- نص خطير، واضح
    ...
    ["@text.environment"] = { fg = palette.aqua_dark, italic = true },      -- بديل عن link = "Macro"
    ["@text.environment.name"] = { fg = palette.yellow_lite, bold = true }, -- بديل عن Type
    ...
    ["@text.title"] = { fg = palette.orange_lite, bold = true },
    ["@text.title.1.markdown"] = { fg = palette.red_lite, bold = true },
    ["@text.title.1.marker.markdown"] = { fg = palette.red_dark },
    ["@text.title.2.markdown"] = { fg = palette.orange_lite, bold = true },
    ["@text.title.2.marker.markdown"] = { fg = palette.orange_dark },
    ["@text.title.3.markdown"] = { fg = palette.yellow_lite, bold = true },
    ["@text.title.3.marker.markdown"] = { fg = palette.yellow_dark },
    ["@text.title.4.markdown"] = { fg = palette.green_lite, bold = true },
    ["@text.title.4.marker.markdown"] = { fg = palette.green_dark },
    ["@text.title.5.markdown"] = { fg = palette.blue_lite, bold = true },
    ["@text.title.5.marker.markdown"] = { fg = palette.blue_dark },
    ["@text.title.6.markdown"] = { fg = palette.purple_lite, bold = true },
    ["@text.title.6.marker.markdown"] = { fg = palette.purple_dark },
    ["@text.underline"] = { underline = true, fg = palette.fg1 },
    ["@text.uri"] = { fg = palette.blue_lite, underline = true },
    ["@text.warning"] = { fg = palette.yellow_lite, bold = true },
    ["@todo"] = { fg = palette.orange_lite, bg = palette.bg3, bold = true, italic = true },
  ...
  local default_highlights = {
    ...
    -- Other UI Elements
    Directory = { fg = palette.blue_lite, bold = true },
    ...
    Boolean = { fg = palette.purple_lite },
    Character = { fg = palette.yellow_lite },
    Comment = { fg = palette.fg2, italic = true },
    Conditional = { fg = palette.blue_lite },
    Constant = { fg = palette.yellow_lite },
    Debug = { fg = palette.purple_lite },
    Define = { fg = palette.purple_dark },
    Delimiter = { fg = palette.fg2 },
    Error = { fg = palette.red_lite },
    Exception = { fg = palette.blue_lite },
    Float = { fg = palette.yellow_lite },
    Function = { fg = palette.purple_lite },
    Identifier = { fg = palette.fg },
    Include = { fg = palette.blue_lite },
    Keyword = { fg = palette.blue_lite },
    Label = { fg = palette.aqua_lite },
    Macro = { fg = palette.purple_dark },
    Number = { fg = palette.yellow_lite },
    Operator = { fg = palette.fg2 },
    PreCondit = { fg = palette.purple_dark },
    PreProc = { link = "PreCondit" },
    Repeat = { fg = palette.blue_lite },
    Special = { fg = palette.aqua_lite },
    SpecialChar = { link = "Special" },
    SpecialComment = { fg = palette.purple_dark },
    Statement = { fg = palette.blue_lite, bold = true },
    StorageClass = { fg = palette.aqua_lite },
    String = { fg = palette.yellow_lite },
    Structure = { fg = palette.aqua_lite },
    Tag = { fg = palette.aqua_lite },
    Todo = { fg = palette.purple_lite, bg = palette.bg_second, bold = true },
    ...
    -- Treesitter
    ["@variable"] = { fg = palette.fg, italic = true },
    ["@variable.builtin"] = { fg = palette.red_lite, italic = true, bold = true },
    ["@variable.parameter"] = { fg = palette.purple_lite, italic = true },
    ["@variable.parameter.builtin"] = { fg = palette.purple_lite, italic = true, bold = true },
    ["@variable.member"] = { fg = palette.aqua_lite },

    ["@constant"] = { fg = palette.yellow_lite },
    ["@constant.builtin"] = { fg = palette.yellow_lite, bold = true },
    ["@constant.macro"] = { fg = palette.yellow_lite },

    ["@module"] = { fg = palette.fg },
    ["@module.builtin"] = { fg = palette.fg, bold = true },
    ["@label"] = { link = "Label" },

    ["@string.regexp"] = { fg = palette.purple_lite },
    ["@string.escape"] = { fg = palette.green_dark },
    ["@string.special.url"] = { fg = palette.blue_lite },

    ["@type"] = { fg = palette.aqua_lite },
    ["@type.builtin"] = { fg = palette.aqua_lite, bold = true },

    ["@attribute"] = { fg = palette.purple_lite },
    ["@attribute.builtin"] = { fg = palette.purple_lite, bold = true },
    ["@property"] = { fg = palette.aqua_lite, italic = true },
    ...
    ["@keyword.import"] = { fg = palette.green_dark },
    ["@keyword.storage"] = { fg = palette.aqua_lite },
    ["@keyword.repeat"] = { fg = palette.green_dark },
    ["@keyword.return"] = { fg = palette.green_dark },
    ["@keyword.debug"] = { fg = palette.red_lite },
    ["@keyword.exception"] = { fg = palette.green_dark },
    ["@keyword.conditional"] = { fg = palette.green_dark },
    ["@keyword.conditional.ternary"] = { fg = palette.green_dark },
    ["@keyword.directive"] = { fg = palette.purple_lite },
    ...
    --- Plugins
    -- romgrk/barbar.nvim
    BufferCurrent = { fg = palette.fg, bg = palette.bg3 },
    BufferCurrentIndex = { fg = palette.fg, bg = palette.bg3 },
    BufferCurrentMod = { fg = palette.aqua_lite, bg = palette.bg3 },
    BufferCurrentSign = { fg = palette.gray, bg = palette.bg3 },
    BufferCurrentTarget = { fg = palette.yellow_lite, bg = palette.bg3 },
    BufferInactive = { fg = palette.gray },
    BufferInactiveIndex = { fg = palette.gray },
    BufferInactiveMod = { fg = palette.aqua_lite },
    BufferInactiveSign = { fg = palette.fg4 },
    ...
    LspSignatureActiveParameter = { bg = palette.bg_third },
