...
local function get_groups()
  ...
  local groups = {
    ...
    BlinkCmpLabelDeprecated = { link = "GruvboxRed", strikethrough = true },
    BlinkCmpLabelMatch = { fg = colors.neutral_blue, bold = true },
    BlinkCmpLabelDetail = { link = "GruvboxGray" },
    BlinkCmpLabelDescription = { link = "GruvboxGray" },
    BlinkCmpDoc = { link = "GruvboxBg0" },
    BlinkCmpDocBorder = { fg = colors.neutral_aqua },
    BlinkCmpDocSeparator = { fg = colors.grey },
    BlinkCmpDocCursorLine = { bg = colors.bg1 },
    BlinkCmpSignatureHelp = { bg = colors.bg0 },
