...
local function get_groups()
  ...
  local groups = {
    ...
    BufferLineBufferSelected = {fg = colors.fg0, bg = colors.bg0},
    ...
    NvimTreeFolderName = { fg = colors.blue, bold = false },
    NvimTreeFolderIcon = { fg = colors.neutral_blue, bold = true },
    NvimTreeEmptyFolderName = { fg = colors.blue, bold = false },
    NvimTreeOpenedFolderName = { fg = colors.blue, bold = false },
    NvimTreeSymlinkFolderName = { fg = colors.green, bold = false },
    ...
    BlinkCmpLabelDeprecated = { link = "GruvboxRed", strikethrough = config.strikethrough },
    BlinkCmpLabelMatch = { link = "GruvboxBlueBold" },
    BlinkCmpLabelDetail = { link = "GruvboxGray" },
    BlinkCmpLabelDescription = { link = "GruvboxGray" },
    BlinkCmpDoc = { link = "GruvboxBg0" },
    BlinkCmpDocBorder = { link = "GruvboxAqua" },
    BlinkCmpDocSeparator = { link = "GruvboxGray" },
    BlinkCmpDocCursorLine = { link = "GruvboxBg1" },
    BlinkCmpSignatureHelp = { link = "GruvboxBg0" },
    BlinkCmpSignatureHelpBorder = { link = "GruvboxYellow" },
    BlinkCmpSignatureHelpActiveParameter = { link = "GruvboxBlueBold" },
    BlinkCmpScrollBarThumb = { link = "GruvboxGray" },
    BlinkCmpScrollBarGutter = { link = "GruvboxBg2" },
