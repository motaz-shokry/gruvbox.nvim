...
local function set_highlights()
  ...
  local default_highlights = {
    ...
    ["@variable.parameter.builtin"] = { fg = palette.blue_lite, italic = true, bold = true },
    ...
    ["@type.builtin"] = { fg = palette.yellow_lite, bold = true },
    ["@type.definition"] = { fg = palette.yellow_lite, bold = true },
    ...
    ["@comment.todo"] = { fg = palette.yellow_lite, bg = palette.bg_second, bold = true },
